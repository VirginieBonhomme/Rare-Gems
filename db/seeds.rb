...
#   Character.create(name: "Luke", movie: movies.first)
 Sneaker.create!(
  ...
  release_date: "08/24/01",
  retail: '$80',
  resale: '$1280'
  description: "A 2001 retro, the Air Jordan 1 Retro 'Bred' 2001 recreates one of the most iconic looks in Jordan Brand history. The familiar mix of black and Varsity Red emerges throughout the upper, with the white Air midsole providing the only contrast. More Varsity Red finishes the outsole. The shoe was released with a silver Jumpman keychain, while the pair is individually numbered—out of 14,884—inside the tongue",
  img_url: ''
)
